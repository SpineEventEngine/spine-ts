...
Status: T-0041 working threat model; dedicated security re-review found SF-011
and SF-012, and architecture assignment is pending.
...
implementation evidence. Canonical review is clean; dedicated security
re-review found SF-011 and SF-012. Architecture assignment is pending; no
...
| TM-006 | D/T    | Delivery availability and persisted attempt/lease integrity; TB-03/TB-04            | Failing endpoint or corrupt row repeatedly triggers retry, retained attempt, lease, scan, or cleanup work.                                                                      | Read/failure/resume caps (`delivery-loop.ts:195-214,352-360`) and delivery retry/retention tests under `packages/server/test/delivery/`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Delivery work is bounded; SF-012 separately leaves durable subscription replay unresolved pending architecture.                                                                                                                                           | Medium; High if unbounded                         |
| TM-007 | S/T/D  | Local IPC integrity, confidentiality, availability; TB-06                           | Same-host attacker controls a configured path component or already has access to the trusted-peer directory and attempts endpoint substitution, spoofing, or oversized V8 work. | SF-010 canonical preparation and identity controls are at `signal-transport.ts:723-897`; setup and publish paths gate before native work at `signal-transport.ts:110-163,180-233,249-290,307-364,401-455`. Deterministic lifecycle, cleanup, and boundary regressions are at `signal-transport.test.ts:72-256,328-410,522-590,770-781,1602-1785`; fresh unrestricted/native 49/49 evidence is in the current Wave 22 correction entry in `work-logs/T-0041.md`.                                                                                                                                             | SF-010 pathname controls and residual remain accepted. SF-011 confirms unbounded trusted-peer frames and is unresolved pending architecture.                                                                                                              | Medium with local prerequisite                    |
