...
findings. Wave 18 findings are fixed and correction verification is current;
Canonical Wave 19 and dedicated security re-review are pending.
...
implementation-evidence endpoint is `fa5e4b65`; later provenance/review/status
commits are not implementation evidence. Canonical Wave 19 review and dedicated
