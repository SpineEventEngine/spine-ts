...
Status: T-0041 working threat model; Canonical Wave 19 found one IPC close-race
reliability correction. Implementation and dedicated security re-review are
pending.
...
commits are not implementation evidence. Canonical Wave 19 correction and
...
| IPC and diagnostics      | `signal-transport.ts:682-855`; `signal-intake.ts:58-115`.                                 |
