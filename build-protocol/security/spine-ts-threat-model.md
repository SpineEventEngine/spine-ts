...
and coordinator-verified; Canonical Wave 23 is clean and focused security
...
canonical review and Canonical Wave 23 are clean; focused security re-review of
SF-011/SF-012 is pending. No security acceptance is claimed.
...
| TM-007 | S/T/D  | Local IPC integrity, confidentiality, availability; TB-06                           | Same-host attacker controls a configured path component or already has access to the trusted-peer directory and attempts endpoint substitution, spoofing, or oversized V8 work. | SF-010 canonical preparation and identity controls are at `signal-transport.ts:723-897`; private 8,388,608-byte native receive caps now cover Subscriber, Request, and Reply before endpoint/native work. Raw-peer +1-byte and valid-continuation regressions passed; full native file 53/53 passed.                                                                                                                                                                                                                                                                                                        | SF-011 implementation and correction verification are current; complete four-lane canonical review and focused security re-review remain pending.                                                                                                         | Medium with local prerequisite                    |
