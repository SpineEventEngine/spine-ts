...
Status: T-0041 working threat model; Canonical Wave 20 findings are accepted and
correction is assigned; dedicated security re-review is pending.
...
implementation-evidence endpoint is `0b7fa354`; later provenance/review/status
commits are not implementation evidence. Canonical Wave 20 correction and
