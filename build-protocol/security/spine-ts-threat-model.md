...
findings. Wave 17 findings are fixed and correction verification is current;
...
implementation-evidence endpoint is `b70ecb08`; later provenance/review/status
commits are not implementation evidence. Canonical review and dedicated
Wave 18 re-review and dedicated security re-review remain pending; no security
