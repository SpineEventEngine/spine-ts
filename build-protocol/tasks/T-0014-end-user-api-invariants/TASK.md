...
- Aggregates must not use retired event-replay handlers; de-event-sourcing makes aggregate appliers
  invalid.
...
- `2026-07-07 16:40 WEST`: Main orchestrator addressed round-14 findings:
  stale event-sourced replay wording was removed, no-retired event-replay handlers/no end-user
...
- `2026-07-07 17:06 WEST`: Main orchestrator completed the framework/example
  ...
  no longer contains retired event-replay handlers, schema-bearing decorators, transaction calls,
...
- `2026-07-07 17:25 WEST`: Round-15 reviewer fixes completed. The managed
  ...
  aggregate retired event-replay handlers, or app-owned materialization as normal application usage.
...
- `2026-07-07 18:18 WEST`: Round-22 architecture documentation findings fixed.
  Architecture docs now scope schema-bearing decorators, retired event-replay handlers, and
...
- `2026-07-07 18:51 WEST`: Round-28 TypeScript/API findings fixed.
  ...
  Public API docs and decorator JSDoc now mark retired event-replay handlers and
...
- `2026-07-07 18:53 WEST`: First lint attempt after the TypeScript/API docs
  fix failed because formal `@deprecated` JSDoc on retired event-replay handlers tripped
...
- Focused tests for aggregate command handling without retired event-replay handlers.
