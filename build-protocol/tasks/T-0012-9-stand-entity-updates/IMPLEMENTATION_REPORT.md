...
Implementation files, tests, docs, and durable logs are integrated into `main`
through commit `9202b5e`. All required review lanes are clean. No blocking
human question is known.
