...
- `TaskAggregate` uses decorated `@Assign(CreateTaskSchema)` and
  event replay methods materialized through the existing
...
- Focused example black-box tests for rename, complete, reopen, duplicate
...
- Status: complete and merged via `e27b033`.
