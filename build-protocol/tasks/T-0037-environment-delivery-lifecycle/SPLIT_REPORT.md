...
| 4     | T-0037d | Registrations/startup, direct-drain ownership switch, failed-start rollback                 |
| 5     | T-0037e | Detach, explicit stop, close invocation, fresh-generation races, permanent close            |
...
the reconciled `80ef21e2` boundary and produced the accepted findings now being
fixed; no clean review is claimed.
