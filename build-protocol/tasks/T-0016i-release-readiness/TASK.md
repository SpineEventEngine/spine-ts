...
- Ordinary end-user code must not use schema-bearing decorators, event replay,
...
2. Inspect public exports for legacy compatibility symbols, especially event replay
...
- Targeted public-doc/source scans were run for stale wording and forbidden
  ...
  `docs/api/README.md`.
- event replay and `materializeDecoratedEntityHandlers()` already had a
