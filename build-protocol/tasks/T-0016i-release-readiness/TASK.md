...
- Ordinary end-user code must not use schema-bearing decorators, retired event-replay handlers,
...
2. Inspect public exports for legacy compatibility symbols, especially retired event-replay handlers
...
- Targeted public-doc/source scans were run for stale wording and forbidden
  ...
  `docs/api/README.md`.
- retired event-replay handlers and `materializeDecoratedEntityHandlers()` already had a
