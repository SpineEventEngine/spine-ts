...
Status: merged into parent branch at cb46983 and parent-verified
...
- Final round-6 re-review and verification passed. The branch was merged into
  the parent `T-0012.11` worktree at `cb46983` and parent-verified.
