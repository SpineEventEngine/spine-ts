...
accepted endpoint work, but they do increment failed work and count toward the
internal failure bound. Live per-message ownership blocks competing delivery;
