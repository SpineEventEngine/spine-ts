...
also complete, release-verified, integrated, and pushed to `origin/main`.
...
retained fallback. T-0213 completed the release-command, documentation, and
acceptance-evidence reconciliation. The deployment correction is closed.
...
- aggregate import/importers, `ImportBus`, or aggregate event replay delivery;
...
decorators, no event replay, no manual transactions, no internal IDs, no default
...
handlers, schema-bearing decorators, aggregate event replay, transaction controls,
...
T-0214 is complete, reviewed, release-verified, and pushed to `main`. It fixes
the proven sustained-subscription lifetime defect, removes unrequested
signing/session concepts from Message Board, gives To-Do and Message Board
purpose-named source and complete commented launchers, wires one stock UI
through every documented browser route, and verifies all locally advertised
