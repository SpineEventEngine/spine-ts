...
export const TaskAssignmentEvent: MessageInterface<
  ...
  (TaskAssigned | TaskUnassigned) & AuthoredTaskAssignmentEvent
> = MessageInterfaces.define(/* validated member schemas */);
```
...
emit. Target at least 90% branch coverage for changed production files; run
