    ...
    try {
      ...
      writeFileSync(
        ...
        [
          ...
          'import { ChatSignal } from "@external/chat-model/generated/interfaces/external/chat/v1/message_board.js";',
          'import type { ChatSignal as ChatSignalType } from "@external/chat-model/generated/interfaces/external/chat/v1/message_board.js";',
