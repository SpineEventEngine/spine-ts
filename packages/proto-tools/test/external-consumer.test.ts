...
describe("packed external model consumer", () => {
  it("builds, packs, and executes composed Spine and application Proto modules without workspace links", () => {
    ...
    try {
      ...
      expect(
        readFileSync(join(chat, "generated/interfaces/chat-signal.ts"), "utf8"),
      ...
      const interfaceCompanion = join(
        chat,
        "generated/interfaces/chat-signal.ts",
      );
      expect(readFileSync(interfaceCompanion, "utf8")).toBe(firstInterfaceOutput);
      const interfaceDeclaration = join(
        chat,
        "dist/generated/interfaces/chat-signal.d.ts",
      );
      ...
      writeFileSync(
        ...
        [
          ...
          'import type { ChatSignal as ChatSignalType } from "@external/chat-model/generated/interfaces/chat-signal.js";',
