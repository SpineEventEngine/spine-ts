...
not native `Server` state. See the [browser/auth extension guide](../../docs/BROWSER_CLIENT_AUTH_EXTENSION_GUIDE.md)
...
- [Authentication gateway](../auth/README.md)
- [Message Board application](../../examples/message-board/app/README.md)
