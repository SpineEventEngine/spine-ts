...
function spec(storageKey: string): RecordSpec<string, ReturnType<typeof create<typeof StringValueSchema>>> {
  return new RecordSpec({ schema: StringValueSchema, storageKey, idKind: "string", extractId: (value) => value.value });
}
