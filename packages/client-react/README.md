...
generated Proto model:

```sh
pnpm add react@^19.2.8 @types/react@^19.2.7
pnpm add @spine-event-engine/client-web@2.0.0-snapshot.3 @spine-event-engine/client-react@2.0.0-snapshot.3
```
...
// BoardMessageViewSchema is generated by this application's model package.
...
void App;
void stopApplication; // Call this from the application's unmount/shutdown path.
```
