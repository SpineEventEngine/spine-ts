...
const BrowserSessionValues = Object.freeze({
  requestDeadline(value: number | undefined): number {
  ...
  requiredToken(value: string): string {
  ...
  freezeContext(value: BrowserSessionContext): BrowserSessionContext {
    if (
  ...
  copyContext(value: BrowserSessionContext): BrowserSessionContext {
    return Object.freeze({
      ...(value.actor === undefined ? {} : { actor: value.actor }),
      ...(value.tenant === undefined ? {} : { tenant: value.tenant }),
      ...(value.expiresAt === undefined ? {} : { expiresAt: new Date(value.expiresAt) }),
  ...
  redactedError(error: unknown, bearer: string | undefined): Error {
