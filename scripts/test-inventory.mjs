...
/**
 * Tests that need a separately provisioned external service or provider account.
 *
 * Ordinary CI always excludes these paths. Their package commands select them
 * through `vitest.infrastructure.config.ts` after checking their own setup.
 */
