...
facade. Map-valued `(set_once)` fields are unsupported in this slice and fail
closed with a field-specific validation violation. Server handler metadata exports include `defineEntityHandlers()`,
