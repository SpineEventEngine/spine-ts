...
entity states; live projection updates reach them through framework-owned
durable inbox handoff and exact-row replay in built contexts, not through a new
application write-side read API.
