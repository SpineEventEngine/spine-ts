...
with the [Chat web README](README.md).

## Composition

`ChatBrowserApp` receives an application-owned browser session and
...
Room state comes from an authoritative Query. A `resynchronization` delivery
